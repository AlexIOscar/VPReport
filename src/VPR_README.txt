...
блок строк, содержащий информацию, собранную по данной директории. В версии v1.4 выводится только два показателя:
...
________________________________________________________________________________________________________________________
4. Содержимое отчетов (вкладка "Отчет")
...
В версии v1.4, используется только в модуле обработки времени заказов, и никак не сказывается на
...
равной длине очереди (в версии v1.4 длина очереди не может быть настроена пользователем, и составляет 32 измерения).
...
6.2 Начиная с версии v1.4, программа использует два репозитория. Второй отличается тем, что, помимо самого времени
